...
Последние два года занимаюсь коммерческой разработкой с фокусом на AI-инструменты. Основной опыт — проектирование и реализация систем автоматизации с использованием LLM-агентов.
