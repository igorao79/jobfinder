...
1. Serpium — приложение для автоматической генерации SEO-оптимизированных лендингов под Google Ads с использованием LLM. Контент, структура и мета-теги генерируются через AI. Реализовал два варианта: на Python с интеграцией внешних сервисов по API и на Next.js. Оба — самостоятельно, от архитектуры до деплоя в production.
...
3. RAG-бот — собственный Retrieval-Augmented Generation бот для поиска и генерации ответов по базе документов. Python, LangChain, векторные БД. GitHub: https://github.com/igorao79/ragtest

4. UIVix — собственная UI-библиотека компонентов с интеграцией MCP для подключения к AI-инструментам. Документация: https://uivix-docs.vercel.app/
...
Портфолио: https://www.igorao79.ru/ (зеркало: https://portfolio-ten-plum-qg4uqxhosd.vercel.app/)
...
3. RAG-бот — собственный RAG-бот для поиска и генерации ответов по базе документов. Python, LangChain, векторные БД. GitHub: https://github.com/igorao79/ragtest

4. UIVix — собственная UI-библиотека компонентов с MCP-интеграцией. Документация: https://uivix-docs.vercel.app/
...
COVER_LETTER_LAYOUT = """Здравствуйте!

Два года в коммерческой разрабке. Делаю чистую, адаптивную верстку под любые устройства.
Стек: HTML5, CSS3, JavaScript, TypeScript, React, Next.js, Tailwind CSS.

1. СырАрт — лендинг для магазина ремесленных сыров: анимации, каталог товаров, форма обратной связи, полностью адаптивный. Демо: https://igorao79.github.io/template1/

2. Зоопарк — многосекционный сайт с галереями, карточками животных и навигацией. Демо: https://igorao79.github.io/template2/

3. Foody — лендинг сервиса доставки еды: меню, корзина, адаптивный UI. Демо: https://foody-blush-eight.vercel.app/

Больше проектов — в моём GitHub: https://github.com/igorao79

Верстаю быстро и аккуратно — использую современные инструменты разработки чтобы работать эффективнее без потери качества верстки. Использую различные ИИ инструменты.
